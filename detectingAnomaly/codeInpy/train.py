...
store_image=[]
train_path='/content/drive/MyDrive/colabFiles'  #Inserir o local onde os videos de treino estão.
fps=5
...
callback_save = ModelCheckpoint("saved_model.h5", monitor="accuracy", save_best_only=True)
